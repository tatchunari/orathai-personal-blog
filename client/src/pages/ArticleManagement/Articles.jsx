  ...
  return (
    <div>
      ...
      <div className="hidden md:flex items-center justify-between space-x-3 border-b-1 border-[#DAD6D1]">
        ...
        <button
          className="flex flex-row items-center gap-3 px-10 py-3 my-5 mr-15 rounded-full text-sm font-light text-white bg-[#26231E] hover:bg-gray-100 transition cursor-pointer"
          >
          <FaPlus />
          Create article
        </button>
      ...
      <div className="flex flex-row justify-between mt-10 mx-4">
        ...
        <div className="flex flex-row gap-x-4">
          ...
          {/* Category */}
          <Select value={category} onValueChange={(e) => setCategory(e.target.value)}>
          ...
          {/* Status */}
          <Select value={status} onValueChange={(e) => setStatus(e.target.value)}>
