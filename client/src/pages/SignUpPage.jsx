          ...
          <div>
            ...
            <div className="mt-1">
              <input
                ...
                className={`block w-full px-4 py-2 bg-white text-gray-900 placeholder-gray-400 border border-gray-300 rounded-md focus:ring-gray-500 focus:border-gray-500 ${formErrors.name ? "border-red-500": ""}`}
          ...
          <div>
            ...
            <div className="mt-1">
              <input
                ...
                className={`block w-full px-4 py-2 bg-white text-gray-900 placeholder-gray-400 border border-gray-300 rounded-md focus:ring-gray-500 focus:border-gray-500 ${formErrors.username ? "border-red-500": ""}`}
                disabled={state.loading}
              />
              {formErrors.name && (
                <p className="text-red-500 text-xs absolute">
